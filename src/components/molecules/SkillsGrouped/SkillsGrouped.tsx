...
import { IconStar } from '@/components/organisms/Icons';
    ...
    <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen max-w-screen bg-[color:var(--color1)] mt-20">
      <div className="max-w-screen-xl mx-auto px-4 py-10 text-[color:var(--neutral1)]">
        <div className="flex items-center justify-center mb-6 gap-2">
          <IconStar color={'var(--color4)'} width={40} height={40}/>
          <h2 className="prose prose-strong:text-[color:var(--color4)] text-[color:var(--color3)] text-4xl font-bold">
            {sectionTitle}
          </h2>
        </div>
